    ...
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 to-blue-900 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-zinc-400">Join the elite network of real estate professionals.</p>
        </motion.div>
        ...
        <motion.div className="relative" variants={itemVariants} transition={{ delay: 0.7 }}>
        ...
        <motion.p className="text-center text-sm text-zinc-400" variants={itemVariants} transition={{ delay: 0.9 }}>
          Already have an account?{' '}
          <Link href="/auth/login" className="font-semibold text-yellow-400 hover:text-yellow-300">
            Login
          </Link>
        </motion.p>
      </motion.div>
